  ...
  <div class="clearfix">
			...
			<div class="col-md-3 form-group">
				<label class="control-label" for="">Órgão expediDor</label>
				 ...
				 <input type="text" name="guarantor_conjuge_organ_issuing" class="form-control" maxlength="8" value="{{(empty($proposals->guarantor_conjuge_organ_issuing) ? "" : $proposals->guarantor_conjuge_organ_issuing)}}">
			</div>
			<div class="col-md-3 form-group">
