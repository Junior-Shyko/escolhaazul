...
<div id="referencia_banco">
    ...
    <div class="col-md-3 ">
        ...
        <input type="text" name="proposal_banking_name_phone" id="proposal_banking_name_phone" onKeyPress="MascaraTelefone(form_dois.proposal_banking_name_phone);" maxlength="15"  onBlur="ValidaTelefone(form_dois.proposal_banking_name_phone);" class="form-control" value="{{$proposals->proposal_banking_name_phone}}">
    </div>  
    <div class="col-md-3 ">
    ...
    <div class="col-md-3 ">
        ...
        <input type="text" name="proposal_banking_client_begin" id="propsota_pf_cliente_desde" onkeypress="MascaraData(form_dois.proposal_banking_client_begin)" class="form-control" value="{{(!empty($proposals->proposal_banking_client_begin) ? $proposals->proposal_banking_client_begin : '')}}">
    </div>
