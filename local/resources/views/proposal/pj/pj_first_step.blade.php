<div class="col-md-12">
	...
	<div class="col-md-8">
		...
		<input type="text" name="legal_location_reference" required id="proposal_reference" class="form-control" >
	</div>
	<div class="col-md-3">
	...
	<div class="col-md-4">
		...
		<div class="input-group">
			<input type="text" class="form-control" name="legal_location_time_contract" id="validate-text" placeholder="Tempo do aluguel">
	...
	<div class="col-md-4">
		...
		<div class="input-group">
		  ...
		  <input type="text" name="legal_location_rent_proposed" id="aluguel_proposto" class="form-control">
		</div>
	</div>
	<div class="col-md-4">
		...
		<div class="input-group">
		  <span class="input-group-addon">R$</span>
		  <input type="text" name="legal_location_value_condominium" id="valor_condominio" class="form-control">
		</div>
	</div>
	...
	<div class="col-md-4">
		...
		<div class="input-group">
		  <span class="input-group-addon">R$</span>
		  <input type="text" name="legal_location_value_iptu" id="iptu_anual" class="form-control">
		</div>
	</div>
				
	<div class="col-md-12">
		<label class="control-label" for="obs">Observações</label>
		<textarea rows="3" name="legal_location_ps" class="form-control" id="obs_proposta" maxlenght="255" name="resumo" id="resumo" value=""></textarea>
	...
	<div class="col-md-12 box">
		...
		<div class="col-md-6">
			...
			<input type="text" name="legal_location_fantasy" class="form-control" />
		</div> 
		<div class="col-md-5">
			<label class="control-label" for="inputSuccess1">CNPJ (MF)</label><small class="text-danger"> (Somente números)</small>
			<input type="text" name="legal_location_cnpj" onKeyPress="MascaraCNPJ(form1.legal_location_cnpj);" maxlength="18"id="legal_cnpj"   onBlur="ValidarCNPJ(form1.legal_cnpj);"class="form-control">
		</div>
		<div class="col-md-7">
			<label class="control-label" for="inputSuccess1">Contato para esclarecimentos</label>
			<input type="text" name="legal_location_contact" class="form-control">
		</div>
		<div class="col-md-4">
    	...
    	<div class="col-md-4">
			...
			<input type="text" name="legal_location_phone_fax" data-mask="(99) 9999-9999" maxlength="15" class="form-control">
		</div>	
    	
    	<div class="col-md-4">
			<label class="control-label" >Celular</label>
			<input type="text" name="legal_location_cel" id="celular2" onkeyup="mascara( this, mtel );" maxlength="15" class="form-control">
		</div>	
	...
	<div class="col-md-4">
		...
		<div class="input-group">
		  <span class="input-group-addon">R$</span>
		  <input type="text" name="legal_location_value_location" id="juridico_valor_alugado" class="form-control">
		</div>
	</div>	
		<div class="col-md-3 ">
			<label class="control-label" for="dtn">Data da Constituição</label>
			<input type="text" name="legal_location_data_constitution" onKeyPress="MascaraData(form_one_pj.legal_location_data_constitution);" id="dt_constituicao"  maxlength="10" class="form-control">
	...
	<div class="col-md-3 ">
		...
		<div class="input-group">
		  <span class="input-group-addon">R$</span>
		  <input type="text" name="legal_location_capital_social" id="capital_social" class="form-control">
		</div>
	</div>	
	<div class="col-md-3 ">
		...
		<div class="input-group">
		  <span class="input-group-addon">R$</span>
		  <input type="text" name="legal_location_salary" id="juridico_salario" class="form-control">
		</div>
	</div>		
	<div class="col-md-3 ">
		...
		<div class="input-group">
		  <span class="input-group-addon">R$</span>
		  <input type="text" name="legal_location_other_rent" id="juridico_outras_rendas" class="form-control">
		</div>
	</div>		
	<div class="col-md-3">
		<label class="control-label" for="inputSuccess1">Origem outras rendas</label>
		<input type="text" name="legal_location_origim_other_rent" class="form-control">
	</div>	
		<div class="col-md-3 ">
	...
	<!-- area residencial -->
		...
		<div class="col-md-2 ">
			...
			<input type="text" name="legal_location_cep" id="input-demo-cep" class="cep form-control">
		</div>
		<div class="col-md-5 ">
			<label class="control-label" for="input-demo-logradouro">Endereço</label>
			<input type="text" name="legal_location_address" id="input-demo-logradouro" class="form-control" data-cep="logradouro">
		</div>
		<div class="col-md-2 ">
			<label class="control-label">Número</label>
			<input type="text" name="legal_location_number" id="input-numero" class="form-control">
		</div>
		<div class="col-md-3 ">
			<label class="control-label" for="">Complemento</label>
			<input type="text" name="legal_location_complenent" class="form-control">
		</div>
		<div class="col-md-5 ">
			<label class="control-label" for="input-demo-bairro">Bairro</label>
			<input type="text" name="legal_location_district" id="input-demo-bairro" class="form-control" data-cep="bairro">
		</div>
		<div class="col-md-4 ">
			<label class="control-label" for="input-demo-cidade">Cidade</label>
			<input type="text" name="legal_location_city" id="input-demo-cidade" class="form-control" data-cep="cidade">	
		</div>
		<div class="col-md-3">	
...
<div class="col-md-12 box">	
	...
	<div class="col-md-12 ">
		...
		<input type="text" name="legal_location_representative_name" id="proposal_name" class="form-control">
	</div>	
	...
	<div class="col-md-3 form-group">
		...
		<input type="text" name="legal_location_representative_date_brith" onKeyPress="MascaraData(form_one_pj.legal_location_representative_date_brith);" id="dtn_legal"  maxlength="10" class="form-control">

	</div>

	<div class="col-md-3 form-group">
		<label class="control-label" for="">Identidade</label>
		<input type="text" name="legal_location_representative_identity" id="identidade_legal_rep1" class="form-control">
	</div>
	
	<div class="col-md-3 form-group">
		<label class="control-label" for="">Órgão expeditor</label>
		<input type="text" name="legal_location_representative_organ_issuer" class="form-control">
	</div>
	 <div class="col-md-3 form-group required-field-block">
		<label class="control-label" for="inputSuccess1">CPF*</label>
		<input type="text" name="legal_location_representative_cpf"   class="form-control" id="cpf" onBlur="javascript:validaCPF(this);">
		<div class="required-icon">
            <div class="text">*</div>
        </div>
    </div>	<div class="col-md-3 form-group">
		<label class="control-label"  for="inputSuccess1">Nacionalidade</label>
		<input type="text" name="legal_location_representative_nationality" class="form-control">
	...
	<div class="col-md-3 form-group">
		...
		<input type="text" name="legal_location_representative_natural" class="form-control">
	</div>
	<div class="col-md-3 form-group">
	...
	<div class="col-md-3 ">
		...
		<div class="col-md-6 form-group">
			...
			<input type="text" name="legal_location_representative_filiation"  class="form-control" placeholder="Nome Completo">
		</div>	
		<div class="col-md-4">
			<label class="control-label">Telefone</label>
			<input type="text" name="legal_location_representative_phone_fixed" data-mask="(99) 9999-9999" class="form-control">
		</div>	
    	
    	<div class="col-md-4">
			<label class="control-label">Celular</label>
			<input type="text" name="legal_location_representative_mobile1" id="celular1" onkeyup="mascara( this, mtel );" maxlength="15" class="form-control">
		</div>	
    	
    	<div class="col-md-4">
			<label class="control-label" >Celular</label>
			<input type="text" name="legal_location_representative_mobile2" id="celular2" onkeyup="mascara( this, mtel );" maxlength="15" class="form-control">
		</div>	
    <div class="col-md-12">
			<label class="control-label">E-Mail</label>
			<input type="text" name="legal_location_representative_email" id="telefone_residencial" class="form-control">
		</div>		                
	<div class="col-md-5 ">
		<label class="control-label" for="inputSuccess1">Profissão</label>
		<input type="text" name="legal_location_representative_profission" class="form-control">
	</div>	
	<div class="col-md-3 ">
		<label class="control-label" >Cargo/Função</label>
		<input type="text" name="legal_location_representative_function"  class="form-control">
	</div>
	<div class="col-md-4">
	...
	<!-- area endereço profissional -->
		...
		<div class="col-md-3">
			...
			<input type="text" id="input-cep"  name="legal_location_representative_cep" type="text" maxlength="9" placeholder="Informe o CEP" class="cep2 form-control">
		</div>
		<div class="col-md-4 ">
			<label class="control-label" for="input-cep-logradouro">Endereço</label>
			<input type="text" id="rua2"  data-cep="input-cep-logradouro" name="legal_location_representative_address" type="text" placeholder="Nome da Rua / Logradouro" class="form-control">
		</div>
		<div class="col-md-2 ">
			<label class="control-label" for="input-number2">Numero</label>
			<input type="text" id="input-number2" name="legal_location_representative_number" class="form-control">
		</div>
		<div class="col-md-3 ">
			<label class="control-label">Complemento</label>
			<input type="text" name="legal_location_representative_complement" class="form-control">
		</div>								
		<div class="col-md-4 ">
			<label class="control-label" for="input-cep-bairro">Bairro</label>
			<input type="text" name="legal_location_representative_district" id="bairro2"  class="form-control">
		</div>
		<div class="col-md-4 ">
			<label class="control-label" >Cidade</label>
			<input type="text" name="legal_location_representative_city" id="cidade2" class="form-control">
		</div>
		<div class="col-md-4">
...
<div class="col-md-12 box">	
	...
	<div class="col-md-12 ">
		<label class="control-label" for="inputSuccess1">Nome Completo</label>
		<input type="text" name="legal_location_representative_name2" id="proposal_filiation" class="form-control">
	</div>	
	<div class="col-md-3 form-group">
		<label class="control-label">Sexo</label>					
	...
	<div class="col-md-3 form-group">
		<label class="control-label" for="dtn">Data de nascimento</label>
		<input type="text" name="legal_location_representative_date_brith2" onKeyPress="MascaraData(form_one_pj.legal_location_representative_date_brith2);" id="dtn_rep_legal01"  maxlength="10" class="form-control">
	</div>

	<div class="col-md-3 form-group">
		<label class="control-label" for="">Identidade</label>
		<input type="text" name="legal_location_representative_identity2" id="identidade_legal_rep2" class="form-control">
	</div>
	
	<div class="col-md-3 form-group">
		<label class="control-label" for="">Órgão expeditor</label>
		<input type="text" name="legal_location_representative_organ_issuer2" class="form-control">
	</div>
	 <div class="col-md-3 form-group">
		<label class="control-label" for="inputSuccess1">CPF</label>
		<input type="text" name="legal_location_representative_cpf2"   class="form-control" id="cpf" onBlur="javascript:validaCPF(this);">
		
    </div>	
    <div class="col-md-3 form-group">
		<label class="control-label"  for="inputSuccess1">Nacionalidade</label>
		<input type="text" name="legal_location_representative_nationality2" class="form-control">
			...
			<div class="col-md-3 form-group">
				...
				<div class="col-md-3 form-group">
					<label class="control-label" for="inputSuccess1">Naturalidade</label>
					<input type="text" name="legal_location_representative_natural2" class="form-control">
				</div>
				<div class="col-md-3 form-group">
					<label class="control-label" for="inputSuccess1">UF</label>
		...
		<div class="col-md-6 form-group">
			<label class="control-label" for="inputSuccess1">Filiação* (nome completo da mãe)</label>
			<input type="text" name="legal_location_representative_filiation2"  class="form-control" placeholder="Nome Completo">
		</div>	
	<div class="col-md-4">
			<label class="control-label">Telefone</label>
			<input type="text" name="legal_location_representative_phone_fixed2" data-mask="(99) 9999-9999"  class="form-control">
		</div>	
    	
    	<div class="col-md-4">
			<label class="control-label">Celular</label>
			<input type="text" name="legal_location_representative_mobile12" id="celular1" onkeyup="mascara( this, mtel );" maxlength="15" class="form-control">
		</div>	
    	
    	<div class="col-md-4">
			<label class="control-label" >Celular</label>
			<input type="text" name="legal_location_representative_mobile22" id="celular2" onkeyup="mascara( this, mtel );" maxlength="15" class="form-control">
		</div>	
    <div class="col-md-12">
			<label class="control-label">E-Mail</label>
			<input type="text" name="legal_location_representative_profission2"  class="form-control">
		</div>		                	                
	<div class="col-md-5 ">
		<label class="control-label" for="inputSuccess1">Profissão</label>
		<input type="text" name="legal_location_representative_profission2" class="form-control">
	...
	<div class="col-md-3 ">
		<label class="control-label" >Cargo/Função</label>
		<input type="text" name="legal_location_representative_function2"  class="form-control">
	</div>
	<div class="col-md-4">
		<label class="control-label">Ligação com a Empresa</label>
	...
	<!-- area endereço profissional -->
		...
		<div class="col-md-3 ">
			...
			<input type="text" id="input-cep_jurifico"  name="legal_location_representative_cep2" type="text" maxlength="9" placeholder="Informe o CEP" class="cep6 form-control">
		</div>
		<div class="col-md-4 ">
			<label class="control-label" for="input-cep-logradouro">Endereço</label>
			<input type="text" id="rua_juridico"  data-cep="input-cep-logradouro" name="legal_location_representative_address2" type="text" placeholder="Nome da Rua / Logradouro" class="form-control">
		</div>
		<div class="col-md-2 ">
			<label class="control-label" for="input-number2">Numero</label>
			<input type="text" id="input-number2" name="legal_location_representative_numbe2" class="form-control">
		</div>
		<div class="col-md-3 ">
			<label class="control-label">Complemento</label>
			<input type="text" name="legal_location_representative_complement2" class="form-control">
		</div>								
		<div class="col-md-4 ">
			<label class="control-label" for="input-cep-bairro">Bairro</label>
			<input type="text" name="legal_location_representative_district2" id="bairro_juridico"  class="form-control">
		</div>
		<div class="col-md-4 ">
			<label class="control-label" >Cidade</label>
			<input type="text" name="legal_location_representative_city2" id="cidade_juridico" class="form-control">
		</div>
		<div class="col-md-4">
			<label class="control-label">UF</label>
