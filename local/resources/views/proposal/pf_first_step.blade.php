<div class="col-md-12">
    ...
    <div class="col-md-3">
        ...
        <select  class="selectpicker" data-live-search="true" name="proposal_type_immobile" value="{{$proposals->proposal_type_immobile}}">
            {{(!empty($proposals->proposal_type_immobile) ?  $proposals->proposal_type_immobile  : '<option value=""selected> -- Selecione -- </option>')}}
    ...
    <div class="col-md-3">
        ...
        <select class="form-control"  name="proposal_id_user" >
            <option>{{(!empty($proposals->proposal_id_user) ? $proposals->proposal_id_user : ' -- Selecione --')}}</option>
    ...
    <div class="col-md-4">
        ...
        <select class="selectpicker form-control" name="proposal_finality" id="proposal_finality">
            ...
            <option>{{(!empty($proposals->proposal_finality) ? $proposals->proposal_finality : ' -- Selecione --')}}</option>            
...
<div class="col-md-12">
  <div class="col-md-12">
    ...
    <div class="col-md-3 ">
      <label class="control-label" for="dtn">Data de nascimento {{$proposals->proposal_date_brith}}</label>
    ...
    <div class="col-md-3">
      ...
      <select name="proposal_estate_civil" id="estado_civil" class="form-control">
            <option>{{(!empty($proposals->proposal_estate_civil) ? $proposals->proposal_estate_civil : ' -- Selecione --')}}</option>
    ...
    <div class="col-md-3 ">
      ...
      <select name="proposal_number_dependent" id="proposal_number_dependent" class="form-control">
            <option>{{(!empty($proposals->proposal_number_dependent) ? $proposals->proposal_number_dependent : '--Selecione--')}}</option>
    ...
    <div class="col-md-3 ">
      ...
      <select name="proposal_degree_education" id="proposal_degree_education" class="form-control">
            <option>{{(!empty($proposals->proposal_degree_education) ? $proposals->proposal_degree_education : '-- Selecione --')}}</option>
    ...
    <div class="col-md-9 ">
      ...
      <input type="text" name="proposal_filiation" value="{{$proposals->proposal_filiation}}" id="proposal_filiation" class="form-control">
    </div>  
    <!-- area residencial -->
    <div class="col-md-12">
      <div class="clear">
    ...
    <div class="col-md-3 ">
      ...
      <select name="proposal_time_residing" id="proposal_time_residing" class="form-control">
            <option>{{(!empty($proposals->proposal_time_residing) ? $proposals->proposal_time_residing : ' -- Selecione --')}}</option>
    ...
    <div class="col-md-3 ">
      ...
      <select name="proposal_type_residence" id="proposal_type_residence"  class="form-control">
            <option>{{(!empty($proposals->proposal_type_residence) ? $proposals->proposal_type_residence : ' -- Selecione --')}}</option>
...
<div class="col-md-3 ">
  ...
  <input type="text" name="proposal_admission_date" onKeyPress="MascaraData(form_one.proposal_admission_date);" id="dtn_admissao"  maxlength="10" class="form-control" {{ (empty($proposals->proposal_admission_date) ? '' : (date("d/m/Y" , strtotime($proposals->proposal_admission_date))) )}}>

</div>
<div class="col-md-3 ">
  <label class="control-label" >Cargo/Função</label>
  <input type="text" name="proposal_function" id="cargo" class="form-control">
</div>
<div class="col-md-3 ">
  <label class="control-label" >Pessoa para contato</label>
  <input type="text" name="proposal_contact_person" id="proposal_contact_person" class="form-control">
</div>
<div class="col-md-3 ">
  <label class="control-label">Telefone (RH)</label>
  <input type="text" name="proposal_phone_rh" id="proposal_phone_rh" onKeyPress="MascaraTelefone(form_one.proposal_phone_rh);" maxlength="14"  onBlur="ValidaTelefone(form_one.proposal_phone_rh);" class="form-control">
</div>
<div class="col-md-3 ">
  <label class="control-label">Ramal</label>
  <input type="text" name="proposal_branch" id="proposal_branch" class="form-control">
</div>
<div class="col-md-6 ">
  <label class="control-label">E-mail (RH)</label>
  <input type="email" name="proposal_email_business" id="proposal_email_business" onblur="validacaoEmail(form_one.proposal_email_business)"  maxlength="60" class="form-control">
    
</div>
<div class="col-md-2 ">
  <label class="control-label">Salário (R$)</label>
  <input type="text" name="proposal_salary" id="salario" class="form-control">
</div>
<div class="col-md-3 ">
  <label class="control-label">Outras rendas (R$)</label>
  <input type="text" name="proposal_rent_other" id="outra_renda" class="form-control">
</div>
<div class="col-md-7 ">
  <label class="control-label">Origem outras rendas</label>
  <input type="text" name="proposal_origin_other_rent" id="proposal_origin_other_rent" class="form-control">
</div>
...
<div class="col-md-3 ">
  ...
  <input type="text" id="input-cep"  name="proposal_cep_business" type="text" maxlength="9" placeholder="Informe o CEP" class="cep2 form-control">
</div>
<div class="col-md-4 ">
  <label class="control-label" for="input-cep-logradouro">Endereço</label>
  <input type="text" id="rua2"  data-cep="input-cep-logradouro" name="proposal_address_business" type="text" placeholder="Nome da rua / logradouro" class="form-control">
</div>
<div class="col-md-2 ">
  <label class="control-label" for="input-number2">Número</label>
  <input type="text" id="input-number2" name="proposal_number_business" class="form-control">
</div>
<div class="col-md-3 ">
  <label class="control-label">Complemento</label>
  <input type="text" name="proposal_complement_business" id="proposal_complement_business" class="form-control">
</div>                
<div class="col-md-4 ">
  <label class="control-label" for="input-cep-bairro">Bairro</label>
  <input type="text" name="proposal_district_business" id="bairro2"  class="form-control">
</div>
<div class="col-md-4 ">
  <label class="control-label" >Cidade</label>
  <input type="text" name="proposal_city_business" id="cidade2" class="form-control">
</div>
<div class="col-md-3 ">
