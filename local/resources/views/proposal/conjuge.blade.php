...
<div class="col-md-12">
    ...
    <p class="text-primary pull-right">Página 2 de 3</p>    
            ...
            <div class="col-md-3 form-group">
                ...
                @if(!empty($proposals->proposal_conjuge_sex))
                <option value="{{$proposals->proposal_conjuge_sex}}" selected>{{$proposals->proposal_conjuge_sex}}</option>
            ...
            <div class="col-md-3 form-group">
                ...
                <input type="text" name="proposal_conjuge_date_brith" onKeyPress="MascaraData(form_one.proposal_conjuge_date_brith);" id="dtn_conjuge" maxlength="10"   class="form-control" value="{{ empty($proposals->proposal_conjuge_date_brith) ? "" : (date("d/m/Y" , strtotime($proposals->proposal_conjuge_date_brith)) )}}">
            ...
            <div class="col-md-3 form-group">
                    <label class="control-label"  for="inputSuccess1">Nacionalidade</label>
                     ...
                     <input type="text" name="proposal_conjuge_nationality"  value="{{empty($proposals->proposal_conjuge_nationality) ? "" : $proposals->proposal_conjuge_nationality}}"  class="form-control">
                ...
                <div class="col-md-3 form-group">
                    ...
                    @if(!empty($proposals->proposal_conjuge_degree_education))
                    <option value="{{$proposals->proposal_conjuge_degree_education}}" selected="">{{$proposals->proposal_conjuge_degree_education}}</option>
                    <option value="" class="separator"></option>
                    @endif
                    <option value="">--Selecione--</option>
                ...
                <div class="col-md-3 form-group">
                    ...
                    <select name="proposal_conjuge_uf" class="selectpicker show-tick form-control">
                        <option value="">{{(!empty($proposals->proposal_conjuge_uf) ? $proposals->proposal_conjuge_uf : ' -- Selecione --')}}</option>
                        <option value="">--Selecione--</option>
                        @include('proposal.uf')
                    </select>   
                </div>
            ...
            <div class="col-md-12">
                ...
                <div class="col-md-3 form-group">
                    ...
                    <select name="proposal_conjuge_clt"  class="selectpicker show-tick form-control">
                     @if(!empty($proposals->proposal_conjuge_clt))
                    <option value="{{$proposals->proposal_conjuge_clt}}" selected="">{{$proposals->proposal_conjuge_clt}}</option>
                    <option value="" class="separator"></option>
                    @endif
                    <option value="">--Selecione--</option>
                ...
                <div class="col-md-3 form-group">
                    ...
                    <input type="text" name="proposal_conjuge_admission_date" id="dtconjugeadmissao" data-mask="99/99/9999"  class="form-control" value="{{ $proposals->proposal_conjuge_admission_date ? "" : (date("d/m/Y" , strtotime($proposals->proposal_conjuge_admission_date)) )}}">
                </div>
                <div class="col-md-3 form-group">
                ...
                <div class="col-md-3 form-group">
                    <label class="control-label">UF</label>
                     <input type="text" id="uf_conjuge" name="proposal_conjuge_uf_business"  class="form-control" value="{{$proposals->proposal_conjuge_uf_business}}">
