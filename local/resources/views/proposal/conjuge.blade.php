...
<div class="col-md-12">
	...
	<p class="text-primary pull-right">Página 2 de 3</p> 	
			...
			<div class="col-md-3 form-group">
				...
				<input type="text" name="proposal_conjuge_cpf" class="form-control" id="cpf" onBlur="javascript:validaCPF(this);">
		    </div>
			...
			<div class="col-md-12 form-group required-field-block">
				...
				<input type="text" name="proposal_conjuge_name" class="form-control">
			...
			<div class="col-md-3 form-group">
				...
				<input type="text" name="proposal_conjuge_date_brith" onKeyPress="MascaraData(form1.proposal_conjuge_date_brith);" id="dtn_conjuge" maxlength="10"  class="form-control">
			</div>

			<div class="col-md-3 form-group">
				<label class="control-label" for="">Identidade</label>
				<input type="text" name="proposal_conjuge_identity" id="identidade_conjuge" class="form-control">
			</div>
			
			<div class="col-md-3 form-group">
				<label class="control-label" for="">Órgão expeditor</label>
				<input type="text" name="proposal_conjuge_organ_issuing" maxlength="8"  class="form-control">
			</div>
			
			<div class="col-md-3 form-group">
					<label class="control-label"  for="inputSuccess1">Nacionalidade</label>
					<input type="text" name="proposal_conjuge_nationality" class="form-control">
				...
				<div class="col-md-3 form-group">
					...
					<input type="text" name="proposal_conjuge_natural" class="form-control">
				</div>
            	...
            	<div class="col-md-3 form-group">
					...
					<input type="text" name="proposal_conjuge_phone_fixed" id="telefone_residencial" data-mask="(99)9999-9999"  class="form-control">
				</div>	
            	
            	<div class="col-md-3 form-group">
						<label class="control-label" for="inputSuccess1">Celular</label>
						<input type="text" name="proposal_conjuge_phone_cel1" id="conjuge_celular1" onkeyup="mascara( this, mtel );" maxlength="15" class="form-control">
				</div>	
            	
            	<div class="col-md-3 form-group">
						<label class="control-label" for="inputSuccess1">Celular</label>
						<input type="text" name="proposal_conjuge_phone_cel2" id="conjuge_celular2" onkeyup="mascara( this, mtel );"  maxlength="15" class="form-control">
				</div>	
            	
            	<div class="col-md-6 form-group">
						<label class="control-label" for="inputSuccess1">E-mail</label>
						<input type="email" name="proposal_conjuge_email" class="form-control">
				</div>
				<div class="col-md-12 form-group">
					<label class="control-label" for="inputSuccess1">Filiação (nome completo da mãe)</label>
					<input type="text" name="proposal_conjuge_filiation" class="form-control" placeholder="Nome completo">
				</div>	   
			...
			<div class="col-md-12">
				...
				<div class="col-md-6 form-group">
					...
					<input type="text" name="proposal_conjuge_profission" class="form-control">
				</div>
				
				<div class="col-md-6 form-group">
					<label class="control-label" for="inputSuccess1">Atividade (em caso de autônomo)</label>
					<input type="text" name="proposal_conjuge_activity" class="form-control">	
				</div>
				
				<div class="col-md-8 form-group">
					<label class="control-label" for="inputSuccess1">Empresa onde trabalha</label>
					<input type="text" name="proposal_conjuge_business" class="form-control">
				</div>
				
				<div class="col-md-4 form-group">
					<label class="control-label" for="inputSuccess1">CNPJ</label>
					
					<input type="text" name="proposal_conjuge_cnpj" data-mask="99.999.999-9999/99" onBlur="ValidarCNPJ(form1.proposal_cnpj);" class="form-control">	
				</div>
				...
				<div class="col-md-3 form-group">
					...
					<input type="text" name="proposal_conjuge_admission_date" id="dtconjugeadmissao" data-mask="99/99/9999" class="form-control">
				</div>
				<div class="col-md-3 form-group">
					<label class="control-label" >Cargo/Função</label>
					<input type="text" name="proposal_conjuge_function"  class="form-control">
				</div>
				<div class="col-md-3 form-group">
					<label class="control-label" >Pessoa para contato</label>
					<input type="text" name="proposal_conjuge_contact_person"  class="form-control">
				</div>
				<div class="col-md-3 form-group">
					<label class="control-label">Telefone(RH)</label>
					<input type="text" name="proposal_conjuge_phone_rh" data-mask="(99) 9999-9999 " class="form-control">
				</div>
				<div class="col-md-3 form-group">
					<label class="control-label">Ramal</label>
					<input type="text" name="proposal_conjuge_branch" class="form-control">
				</div>
				<div class="col-md-6 form-group">
					<label class="control-label">E-mail</label>
					<input type="email" name="proposal_conjuge_email_business"  class="form-control">
				</div>
				<div class="col-md-2 form-group">
					<label class="control-label">Salário(R$)</label>
					<input type="text" name="proposal_conjuge_salary" id="salario_conjuge"  class="form-control">
				</div>
				<div class="col-md-3 form-group">
					<label class="control-label">Outras rendas(R$)</label>
					<input type="text" name="proposal_conjuge_rent_other" id="salario_conjuge_outras_rendas" class="form-control">
				</div>
				<div class="col-md-7 form-group">
					<label class="control-label">Origem outras rendas</label>
					<input type="text" name="proposal_conjuge_origin_other_rent" class="form-control">
				</div>
				...
				<div class="col-md-3 form-group">
					...
					<input type="text" id="cep-conjuge" name="proposal_conjuge_cep_business" type="text" maxlength="9" placeholder="Informe o CEP"   class="cep3 form-control">
				</div>
				<div class="col-md-4 form-group">
					<label class="control-label">Endereço</label>
					<input type="text" id="rua_conjuge" name="proposal_conjuge_address_business" type="text" placeholder="Nome da Rua / Logradouro" class="form-control">
				</div>
				<div class="col-md-2 form-group">
					<label class="control-label">Número</label>
					<input type="text" name="proposal_conjuge_number_business" class="form-control">
				</div>
				<div class="col-md-3 form-group">
					<label class="control-label">Complemento</label>
					<input type="text" name="proposal_conjuge_complement_business" class="form-control">
				</div>								
				<div class="col-md-4 form-group">
					<label class="control-label">Bairro</label>
					<input type="text" id="bairro_conjuge" name="proposal_conjuge_district_business" class="form-control">
				</div>
				<div class="col-md-3 form-group">
					<label class="control-label" >Cidade</label>
					<input type="text" id="cidade_conjuge" name="proposal_conjuge_city_business" class="form-control">
				</div>	
				<div class="col-md-3 form-group">
