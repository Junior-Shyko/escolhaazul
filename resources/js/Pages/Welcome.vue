                                ...
                                <div class="">
                                    ...
                                    <div class="my-3">
                                        <input type="text"
                                            ...
                                            placeholder="Nome Completo" maxlength="22" x-model="cardholder" />
                                    </div>
                                    <div class="my-3">
                                        <input type="text"
                                            class="block w-full px-5 py-2 border rounded-lg bg-white shadow-lg placeholder-gray-400 text-gray-700 focus:ring focus:outline-none"
                                            placeholder="E-mail" x-model="cardNumber" x-on:keydown="format()"
                                            x-on:keyup="isValid()" maxlength="19" />
                                    </div>
                                    <div class="my-3">
                                        <input type="text"
                                            class="block w-full px-5 py-2 border rounded-lg bg-white shadow-lg placeholder-gray-400 text-gray-700 focus:ring focus:outline-none"
                                            placeholder="Telefone de contato" x-model="cardNumber" x-on:keydown="format()"
                                            x-on:keyup="isValid()" maxlength="19" />
                                    </div>
